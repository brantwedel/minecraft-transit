...
# corner pieces
setblock ~-4 ~1 ~2 minecraft:black_stained_glass_pane[south=true, east=true] replace
setblock ~-4 ~1 ~-2 minecraft:black_stained_glass_pane[north=true, east=true] replace

# benches
fill ~-4 ~0 ~-1 ~-4 ~0 ~1 minecraft:oak_stairs[facing=west] replace

# roof
fill ~-4 ~2 ~-2 ~-4 ~2 ~2 minecraft:spruce_slab[type=bottom] replace
fill ~-3 ~2 ~-2 ~-3 ~2 ~2 minecraft:spruce_stairs[facing=east] replace
...
# paintings
summon painting ~-2 ~0 ~-3 {Facing:2, Motive:wanderer}
summon painting ~-2 ~0 ~-1 {Facing:0, Motive:wanderer}
summon painting ~-2 ~0 ~1 {Facing:2, Motive:graham}
summon painting ~-2 ~0 ~3 {Facing:0, Motive:graham}

# pressure plates
fill ~-2 ~0 ~-1 ~-3 ~0 ~1 minecraft:stone_pressure_plate replace
setblock ~-3 ~0 ~-1 minecraft:lever[face=floor, facing=east]
