...
# corner pieces
setblock ~2 ~1 ~-4 minecraft:black_stained_glass_pane[west=true, south=true] replace
setblock ~-2 ~1 ~-4 minecraft:black_stained_glass_pane[east=true, south=true] replace

# benches
fill ~-1 ~0 ~-4 ~1 ~0 ~-4 minecraft:oak_stairs[facing=north] replace

# roof
fill ~-2 ~2 ~-4 ~2 ~2 ~-4 minecraft:spruce_slab[type=bottom] replace
fill ~-2 ~2 ~-3 ~2 ~2 ~-3 minecraft:spruce_stairs[facing=south] replace
...
# paintings
summon painting ~-3 ~0 ~-2 {Facing:1, Motive:graham}
summon painting ~-1 ~0 ~-2 {Facing:3, Motive:graham}
summon painting ~1 ~0 ~-2 {Facing:1, Motive:wanderer}
summon painting ~3 ~0 ~-2 {Facing:3, Motive:wanderer}
