...
function _transit:partials/bus_awning_east
...
# wheels
fill ~-3 ~-4 ~2 ~-2 ~-4 ~2 minecraft:grindstone[face=ceiling, facing=north] replace
fill ~-3 ~-4 ~-2 ~-2 ~-4 ~-2 minecraft:grindstone[face=ceiling, facing=north] replace
...
fill ~-3 ~-3 ~3 ~-2 ~-3 ~3 minecraft:smooth_quartz_stairs[facing=north]
...
setblock ~-2 ~-4 ~-1 minecraft:smooth_quartz_stairs[facing=west] replace
...
# command blocks
setblock ~3 ~-5 ~-3 minecraft:command_block[facing=south] replace
data merge block ~3 ~-5 ~-3 {Command:"execute if entity @p[distance=..7] run clone ~-3 ~0 ~0 ~-6 ~3 ~6 ~-6 ~4 ~0"}
setblock ~3 ~-5 ~-2 minecraft:chain_command_block[facing=south] replace
###data merge block ~3 ~-5 ~-2 {Command:"fill ~-4 ~4 ~-5 ~-6 ~4 ~1 minecraft:brown_terracotta replace minecraft:coarse_dirt"}

setblock ~1 ~-5 ~-3 minecraft:command_block[facing=south] replace
data merge block ~1 ~-5 ~-3 {Command:"fill ~-1 ~5 ~0 ~-4 ~7 ~6 minecraft:air replace"}
setblock ~1 ~-5 ~-2 minecraft:chain_command_block[facing=south] replace
...
setblock ~3 ~-3 ~-2 minecraft:redstone_wire[south=up, north=side]

setblock ~1 ~-4 ~-2 minecraft:redstone_wire[east=side]
setblock ~1 ~-4 ~-3 minecraft:redstone_wire
setblock ~2 ~-4 ~-2 minecraft:redstone_wall_torch[facing=west] replace

# pressure plates
#fill ~2 ~0 ~-1 ~3 ~0 ~1 minecraft:stone_pressure_plate replace
#setblock ~3 ~0 ~-1 minecraft:lever[face=floor, facing=north]
