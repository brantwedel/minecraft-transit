...
fill ~3 ~0 ~-4 ~3 ~0 ~5 minecraft:spruce_trapdoor[open=true,facing=east] keep
fill ~-3 ~0 ~-4 ~-3 ~0 ~5 minecraft:spruce_trapdoor[open=true,facing=west] keep

fill ~1 ~0 ~-3 ~2 ~0 ~6 minecraft:spruce_trapdoor[open=false,facing=west] keep
fill ~-1 ~0 ~-4 ~-2 ~0 ~6 minecraft:spruce_trapdoor[open=false,facing=east] keep
...
#fill ~-3 ~4 ~0 ~3 ~8 ~0 minecraft:brown_stained_glass_pane keep
#fill ~-2 ~3 ~0 ~2 ~3 ~0 minecraft:brown_stained_glass_pane keep
